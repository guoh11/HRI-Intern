...
- `arXiv 2023` Predicting the Next Action by Modeling the Abstract Goal [[Paper]([https://arxiv.org/pdf/2209.05044.pdf](https://arxiv.org/pdf/2209.05044.pdf))]
...
- `GCPR 2020` Long-term anticipation of activities with cycle consistency. [[Paper](https://arxiv.org/pdf/2009.01142.pdf)]
...
- `BMVC 2019` Forecasting future action sequences with neural memory networks [[Paper](https://arxiv.org/pdf/1909.09278.pdf)]
...
- `JN 2003` The neural correlates of noun and verb processing [[Paper](https://drive.google.com/file/d/1akDbW8WvXVp_S7IMhGB0TQ9qYyiOr0vN/view?usp=sharing)]
